...
void compute_sub_0001(
  ...
  int8_t model_3_tf_strided_slice_2_StridedSlice_70185[37632] , // 1,112,112,3
  
  int8_t model_3_tf_strided_slice_3_StridedSlice_70186[37632]  // 1,112,112,3
  
) {
  // Buffers allocated on the main storage (note: depends on the execution order)
    
  
  int8_t* model_3_tf_strided_slice_StridedSlice_70184 = (int8_t *) &main_storage[0]; // 1,112,224,3 == 75264
...
StridedSlice(serving_default_images_0,  // input data
  model_3_tf_strided_slice_StridedSlice_70184,      // output data
...
StridedSlice(model_3_tf_strided_slice_StridedSlice_70184,  // input data
  model_3_tf_strided_slice_3_StridedSlice_70186,      // output data
...
StridedSlice(model_3_tf_strided_slice_StridedSlice_70184,  // input data
  model_3_tf_strided_slice_2_StridedSlice_70185,      // output data
  Int32VecConstant_70003_0,       // begin
