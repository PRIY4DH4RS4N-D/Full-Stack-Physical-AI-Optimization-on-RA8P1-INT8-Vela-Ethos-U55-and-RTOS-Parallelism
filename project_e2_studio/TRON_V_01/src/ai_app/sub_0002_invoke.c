...
BSP_PLACE_IN_SECTION(".sdram_noinit")
BSP_ALIGN_VARIABLE(16)
uint8_t sub_0002_arena[814032];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0002_fast_scratch[814032];
...
int sub_0002_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0002_model with size 4660336 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0002_model_data;
  base_addrs_size[0] = sub_0002_model_data_size;
  // Buffer sub_0002_arena with size 814032 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0002_arena+0);
  base_addrs_size[1] = 814032;

  // Buffer sub_0002_fast_scratch with size 814032 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0002_arena+0);
  base_addrs_size[2] = 814032;
  ...
  // Buffer output_tensor_0 with size 87465 and address: 96880
  if (clean_outputs) {
    memset(sub_0002_arena + 96880, 0, 87465);
  }
  base_addrs[7] = (uint64_t)(uintptr_t) (sub_0002_arena+96880);
